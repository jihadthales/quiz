    ...
    <div class="header">
      <div class="row">
        ...
        <div class="col-md-2 col-md-offset-4">
          <a href="#" class="pull-right btn sub1" data-toggle="modal" 
          data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true">
            </span>&nbsp;<span class="title1"><b>Signin</b></span></a>
        </div>
        <!--sign in modal start-->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>
              <div class="row">
                <div class="col-md-4">
                  <img src="style/image/CAM00121.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
                </div>
                <div class="col-md-5">
          ...
          <div class="modal-body title1">
            <div class="row">
              <div class="col-md-3"></div>
                <div class="col-md-6">
                  <form role="form" method="post" action="{{url('/adminaccess')}}">
                    @csrf
                    <div class="form-group">
